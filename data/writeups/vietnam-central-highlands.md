...
- **Morphology:** Tall sativa structure adapted to plateau tropical conditions — likely with slightly more robust branching than equatorial lowland types, reflecting the seasonal plateau climate.
- **Flowering:** 11–14 weeks, consistent with tropical sativas at this latitude and altitude.
- **Aroma/Effect:** Central Highland Vietnamese cannabis is not specifically documented in collector literature; regional tropical sativas are broadly associated with sweet, spicy, and earthy profiles.
- **Climate adaptation:** Plateau tropical — warm year-round but with a meaningful dry season; lower humidity than coastal Vietnam; moderate altitude.

## Grow Information

- **Height:** Tall; vigorous sativa growth.
- **Flowering time:** 11–14 weeks; a more manageable range than some extreme tropical sativas.
- **Climate:** Suited to subtropical or tropical conditions with good seasonal variation. The plateau origin may provide marginally better adaptation to less-than-saturated humidity compared to coastal island varieties.
- **Notes:** The Dak Lak / Kon Tum region (as the summary specifies) should not be confused with northern Vietnamese highland cannabis, which belongs to a different ecological and genetic context. This population is specifically associated with the Tay Nguyen plateau of south-central Vietnam.
