...
- **Height:** Medium
- **Flowering Time:** 9–13 weeks; moderate for an indica-leaning mountain landrace
...
- **Climate:** Mountain forest — cool, moist conditions on north-facing Caspian-facing slopes; more arid on the plateau-facing southern exposures
- **Altitude:** Cultivation reported across a wide elevational range from mid-slope forest zones up to the treeline
- **Moisture:** Higher humidity relative to most Middle Eastern landraces; some adaptation to seasonal rainfall and Caspian-derived precipitation
- **Cold tolerance:** Typically moderate to good; cool nights are characteristic of the Alborz growing season
- Cultivators outside Iran should treat this as a cool-climate mountain indica that may prefer moderate humidity over the extreme arid conditions suited to Afghan highland types.
