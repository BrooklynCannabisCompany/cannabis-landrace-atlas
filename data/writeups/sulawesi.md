...
- **Height:** Tall
- **Flowering Time:** 11–15 weeks; the range reflects expected variation within an unselected landrace population.
...
- **Height:** Tall; space accordingly for indoor cultivation.
- **Flowering time:** 11–15 weeks; mid-to-long range for tropical sativas.
- **Climate:** Best suited to warm, humid conditions year-round. Cold sensitivity is expected given equatorial island origin.
- **Notes:** As an island-adapted population with limited recorded collection history, the Sulawesi gene pool may show both genetic diversity and a degree of isolation-driven divergence from mainland Southeast Asian sativas. Phenotypic variation across a seed batch is likely.
