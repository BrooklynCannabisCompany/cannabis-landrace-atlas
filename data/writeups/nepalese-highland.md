...
- 10–14 week flowering is a manageable window for experienced sativa growers; outdoor cultivation in temperate climates with long seasons is appropriate
- Himalayan mixed-zone origin means moderate cold tolerance; better adapted to cool nights than tropical landraces but not as extreme as the highest-altitude types
- Tall stature benefits from training indoors; outdoor plants can be allowed to develop naturally in open settings
- High genetic diversity within the complex is both a challenge (inconsistent expression) and an opportunity (broad selection potential)
- The most accessible entry point into Nepalese highland genetics; seed-bank material under this name is relatively common, though provenance and stability vary
