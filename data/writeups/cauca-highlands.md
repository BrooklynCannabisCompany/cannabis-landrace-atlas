...
- **Climate:** Tropical Highland (recorded as “Andean highlands”)
...
- **Flowering Time:** 12–18 weeks — the wide range reflects the mixed genetic category and the variability expected across a high-elevation landrace population
...
- **Climate:** Andean highlands — adapted to daytime warmth, cool to cold nights, strong UV exposure, and seasonal mist and rainfall
- **Temperature tolerance:** Handles cool nights significantly better than lowland Colombian or equatorial Amazon types; a distinct advantage for temperate outdoor growers
- **Flowering duration:** 12–18 weeks; expect variability across individuals in this mixed population
- **Outdoor suitability:** Well suited to mid-to-high altitude subtropical outdoor environments; greenhouse cultivation extends the viable range to cooler climates
- **Soil:** Mountain Andean soils are typically well-drained and moderately fertile; these plants are accustomed to volcanic-origin substrates
