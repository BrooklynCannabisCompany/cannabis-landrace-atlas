...
- **Structure:** Vigorous, upright, and long-branching; the open structure is typical of southern African sativa types adapted to warm, sunny conditions
...
- **Aroma/Effect:** Mango sweetness is the most commonly reported aromatic characteristic; effects are described as uplifting and long-lasting, reflecting the classic sativa profile

## Grow Information

- **Climate:** Subtropical highland — warm to hot summers, mild to cool winters, well-defined wet season (summer) and dry season (winter), significant sunlight hours
- **Adaptation:** Adapted to Eswatini's subtropical climate, including seasonal drought in winter; very tall growth and long flowering indicate a plant that benefits from a full outdoor growing season
- **Outdoor suitability:** Well suited to subtropical and warm temperate outdoor environments with long summers; would require greenhouse support in temperate climates to achieve full maturity
- **Flowering time:** 12–16 weeks outdoors; timing aligns with the Southern Hemisphere growing season, with harvest typically in autumn
- **Notes:** Swazi Gold is one of the better-known African sativa names and has been used in multiple breeding projects; however, authentic landrace material from Eswatini may differ substantially from seed-bank offerings that carry the name
