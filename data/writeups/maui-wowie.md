...
Maui Wowie is among the more accessible Hawaiian heirlooms for growers outside the tropics, with a relatively moderate 9–11 week flowering window. Plants commonly show good vigor and can be grown both outdoors in warm climates and indoors under adequate light. The tropical island acclimatization means plants generally handle humidity reasonably well. Growers report that Maui Wowie can stretch significantly during early flowering, consistent with its sativa heritage. Many modern seed bank offerings labeled "Maui Wowie" are selected or hybridized versions rather than original Hawaiian stock, so provenance can vary.
