...
- **Morphology:** Tall plants with a mixed sativa/indica character, consistent with a highland population under tropical upland conditions. Broader leaflets than typical coastal Southeast Asian sativas are plausible given altitude and latitude.
- **Flowering:** Long-cycling at 12–18 weeks, a range suggesting heterogeneous genetics within the population.
- **Aroma/Effect:** Limited verified accounts exist; regional highland Cambodian and Lao cannabis is broadly associated with earthy, spicy, and occasionally sweet profiles.
- **Climate adaptation:** Tropical upland conditions — warm days, cooler nights at elevation, high humidity, and a pronounced monsoon season.

## Grow Information

- **Height:** Tall; expect vigorous vertical growth.
- **Flowering time:** 12–18 weeks is a wide range, indicating population variability. Growers should select for earlier-finishing phenotypes if needed.
- **Climate:** Best suited to tropical or subtropical highland conditions. Indoors, long-season management is necessary.
- **Notes:** As one of Cambodia's most isolated cannabis regions, the Ratanakiri gene pool may harbor substantial genetic diversity. Selecting and stabilizing specific phenotypes from this population is likely to take multiple generations.
