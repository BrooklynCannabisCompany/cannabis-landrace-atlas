...
## Description
- Very tall feral sativa morphology typical of equatorial African cannabis populations.
- Extreme mold resistance is the most distinctive noted characteristic — an adaptation to the high-humidity rainforest environment.
- Flowering time is variable, as expected for equatorial populations with minimal seasonal photoperiod change.
- Cannabinoid and terpene profiles are undocumented.
