...
- **Flowering Time:** 10–14 weeks — the moderate-to-short finish is consistent with selection pressure from the Chaco's pronounced dry season, favoring plants that can complete their cycle before water stress peaks
...
- **Climate:** Dry woodland — hot summers, mild winters, extreme drought cycles punctuated by seasonal flooding; one of South America's most demanding environments for plant survival
- **Heat tolerance:** A primary adaptation trait; Chaco feral cannabis is associated with the ability to survive sustained temperatures that would stress many other landraces
- **Drought tolerance:** Grower accounts are limited, but feral persistence in the Chaco strongly implies meaningful drought resilience
- **Flowering duration:** 10–14 weeks — on the shorter end for South American populations, making it potentially useful in environments with limited warm seasons
- **Preservation note:** Feral status means no deliberate selection for quality traits; significant phenotypic variability should be expected
