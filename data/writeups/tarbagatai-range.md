...
## Description
- Mountain cannabis population; medium-tall stature adapted to alpine steppe conditions.
- Mixed morphology with characteristics consistent with Central Asian mountain landraces.
- Cold tolerance expected given the harsh alpine steppe climate of the Tarbagatai range.
- Likely shows early-maturation tendencies suited to the short growing season at elevation.
