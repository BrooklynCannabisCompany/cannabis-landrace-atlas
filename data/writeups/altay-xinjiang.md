...
- **Height:** Medium-tall
- **Stature:** Likely adapted to open steppe and foothill terrain; branching structure suited to wind-exposed slopes
- **Flowering:** 10–14 weeks; relatively long for a cold-climate population, suggesting some Sativa-leaning influence
- **Resin:** Variable; mountain-steppe populations in this region are not typically characterized by heavy resin production comparable to Hindu Kush or Pamir landraces
- Specific phenotype data for this population is limited in available literature.

## Grow Information

- **Climate:** Alpine foothill — cold winters, relatively short warm season, continental temperature swings
- **Altitude:** Altay Prefecture valleys and foothills range from roughly 600 m to over 2,000 m depending on location
- **Cold hardiness:** Expected to be high given the latitude and elevation
- **Season:** The 10–14 week flowering window requires an early start to complete before hard autumn frosts
- Cultivators interested in this population should treat it as a cold-adapted, potentially autoflowering-adjacent landrace from a very northern growing region.
