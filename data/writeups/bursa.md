...
- **Category:** Hybrid-Intermediate (Indica–Sativa)
- **Height:** Medium-tall
- **Stature:** Moderate branching; a balanced phenotype without the extreme compactness of Afghan-derived mountain types or the lanky structure of equatorial sativas
- **Flowering:** 9–13 weeks; moderate for a Turkish landrace, consistent with the mild-to-warm Mediterranean lowland climate
- **Resin:** Moderate; consistent with a landrace region known more for hemp than for intensive hashish production
- The Mediterranean lowland climate — warm, moderately humid summers, mild winters — supports a growing season longer than the Anatolian plateau but shorter than the Black Sea coast.

## Grow Information

- **Climate:** Mediterranean lowland — warm summers, mild winters with some rain, moderate humidity from the Sea of Marmara; roughly Csa/Cfa in Köppen classification
- **Altitude:** Bursa Province includes both coastal lowlands and the slopes of Uludağ (reaching 2,543 m), but cultivation is likely concentrated at low to mid elevations
- **Season:** The 9–13 week flowering window allows late-summer to autumn harvest under natural conditions in northwestern Turkey
- **Versatility:** The intermediate character of this population may make it adaptable to a relatively wide range of temperate cultivation environments
- Cultivators should expect a moderate, balanced plant that does not require extreme heat, cold hardiness, or drought tolerance.
